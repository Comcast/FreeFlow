...
public interface BaseSectionedAdapter {
	...
	// throw new
	// IllegalArgumentException("section is less than 0 or has not been created yet.");
	// }
	//
	...
	// throw new
	// IllegalArgumentException("position is less than 0 or greater than section data count.");
	// }
	//
	...
	public abstract int getViewType(ItemProxy proxy);
